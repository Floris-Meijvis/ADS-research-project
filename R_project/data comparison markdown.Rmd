...
obj_fn = function(params) logLikMultinom(params, data_multinom$data)
...
obj_fn = function(params) logLikMultinom(params, data_adjacent$data)
...
Gradient functions appear to not work properly, leave them out for now.
 -> for adjacent categories: problem lies in coefficients, not intercepts.
 -> multinomial gradient has problems in both intercepts and coefficients.
