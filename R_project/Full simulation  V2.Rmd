...
test = generate_ordinal_multinomial_data(N, k, p, alpha_M, beta_M)
...
test = generate_adjacent_categories_data(N, k, p, alpha_A, beta_A)
```
...
- Update simulation to only vary the Sample size, not change the parameters of the models that generate it.
